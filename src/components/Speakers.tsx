...
const SPEAKERS: Speaker[] = [
  ...
  { name: "Ana Paula Brasil", role: "Gerente de Valor Social", org: "Globo", accent: "#4A8C3F", bg: "rgba(74,140,63,0.06)" },
  { name: "Josefa Camara", role: "Representante", org: "Conselho Ribeirinho", accent: "#4A8C3F", bg: "rgba(74,140,63,0.06)", photo: josefaImg },
  { name: "Gilson Camboim", role: "Presidente", org: "Fecomin / OCB", accent: "#7B2D1E", bg: "rgba(123,45,30,0.06)", photo: gilsonImg },
